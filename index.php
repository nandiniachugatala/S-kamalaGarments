...
<section class="menus">
    <div class="menu-1 bg-dark p-5" id="menus">
        <div class="container">
            <p class="h1 text-center fw-bold text-white m-2 text-align-jusitify"> About Us</p> <br>
            ...
            <div class="grid">
                <div class="row text-white  fw-bold align-items-center"  >
                    ...
                    <div class="col-md-6" align="justify">
                        <p class="h4 fw-bold text-justify">  <br>
        ...
        <div class="grid">
            <div class="row m-5">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="lead text-white" align="justify">We offer our clients excellent quality services for many years, with best Dreeses for the Kid's</p>
                </div>
